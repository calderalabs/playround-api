...
depalo_house = Arena.new({ :name => "Depalo's House", :latitude => 43.328092, :longitude => 11.3157779000001, :description => "The best house in the world"})
depalo_house.user_id = matteo.id
depalo_house.save!
puts "Depalo's House was created" if !!depalo_house

giorni_house = Arena.new({ :name => "Giorni's House", :latitude => 43.3361655, :longitude => 11.3023851, :description => "The worst house in the world"})
